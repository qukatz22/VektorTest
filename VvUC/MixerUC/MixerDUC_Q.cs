...
public class PCK_Unikat : PCK_Artikl
{
   public string PCK_Serno     { get; set; }
   public PCK_Unikat(string _PCK_serno, string _PCK_ArtCD, string _PCK_ArtName, string _PCK_RAMkind, string _PCK_HDDkind, string _PCK_SklCD, decimal _PCK_RAM, decimal _PCK_HDD) : 
