...
public class ExtCjeniciDUC : MixerDUC
{
   ...
   public ExtCjeniciDUC(Control parent, Mixer _mixer, VvSubModul vvSubModul) : base(parent, _mixer, vvSubModul)
   {
...
public class NazivArtiklaZaKupcaDUC : MixerDUC
{
   ...
   public NazivArtiklaZaKupcaDUC(Control parent, Mixer _mixer, VvSubModul vvSubModul) : base(parent, _mixer, vvSubModul)
   {
      dbNavigationRestrictor = new ZXC.DbNavigationRestrictor
         (Mixer.tt_colName, new string[] 
         { 
