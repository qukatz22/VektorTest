...
public class FakturListUC : /*VvRecLstUC*/VvDocumRecLstUC
{
   ...
   protected override void CreateDataGridViewColumn()
   {
      ...
      bool is2NPl = (ZXC.IsTETRAGRAM_ANY && (ZXC.TheVvForm.TheVvUC is IRA_MPC_DUC || ZXC.TheVvForm.TheVvUC is PON_MPC_DUC || ZXC.TheVvForm.TheVvUC is OPN_MPC_DUC || ZXC.TheVvForm.TheVvUC is POT_DUC || ZXC.TheVvForm.TheVvUC is ZAR_DUC));
