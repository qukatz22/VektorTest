...
public class ArtiklListUC : VvRecLstUC
{
   ...
   protected override void CreateDataGridViewColumn()
   {
      ...
      else
      {
         ...
         colWidth = ZXC.Q2un;            sumOfColWidth += colWidth; AddDGVColum_String_4GridReadOnly(TheGrid, "Tip"       , colWidth, false, "ts");
         colWidth = ZXC.Q2un;            sumOfColWidth += colWidth; AddDGVColum_String_4GridReadOnly(TheGrid, "Gr1"       , colWidth, false, "grupa1CD");
         colWidth = ZXC.Q4un;            sumOfColWidth += colWidth; AddDGVColum_String_4GridReadOnly(TheGrid, "KPD"       , colWidth, false, "partNo");
         // 18.04.2018: 
   ...
   public void btn_PCKinfo_Click(object sender, EventArgs e)
   {
      ...
      if(currArtiklCD.NotEmpty() && artiklTS == ZXC.PCK_TS)
      {
       ...
       //List<PCK_Artikl> PCK_SviArtikliList  = RtranoDao.Get_PCK_ArtiklList_ByPCK_Baza_AndSklad(TheDbConnection, null                                   , Fld_SituacijaZaSkladCD, ZXC.PCK_Info_Kind.SveBazeOnly, false, false);
         List<PCK_Artikl> PCK_ArtiklInfo_List = RtranoDao.Get_PCK_ArtiklList_ByPCK_Baza_AndSklad(TheDbConnection, Get_Artikl_FromVvUcSifrar(currArtiklCD), Fld_SituacijaZaSkladCD, ZXC.PCK_Info_Kind.OvaBazaOnly, ""    , ""  );
         List<PCK_Artikl> PCK_SviArtikliList  = RtranoDao.Get_PCK_ArtiklList_ByPCK_Baza_AndSklad(TheDbConnection, null                                   , Fld_SituacijaZaSkladCD, ZXC.PCK_Info_Kind.SveBazeOnly, ""    , ""  );
