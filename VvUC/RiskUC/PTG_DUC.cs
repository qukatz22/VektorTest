...
public class MOD_PTG_DUC : FakturPDUC
{
...

   {
      ...
      vvtbT_dimX      .JAM_ForeColor = 
      vvtbT_ramTarget2.JAM_ForeColor = Color.Orange;
      vvtbT_decA      .JAM_ForeColor = 
      vvtbT_hddTarget2.JAM_ForeColor = Color.MediumSeaGreen;
   }
