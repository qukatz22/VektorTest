...
public class AmortListUC : /*VvRecLstUC*/VvDocumRecLstUC
{
   #region Fieldz
   ...
   public AmortListUC(Control parent, Amort _amort, VvForm.VvSubModul vvSubModul) : base(parent)
   {
      ...
      this.MasterSubModulEnum = ZXC.VvSubModulEnum.AMO;
   ...
   {
      recordSorter = Amort.sorterDokNum;

      this.ds_amort = new Vektor.DataLayer.DS_FindRecord.DS_findAmort();

      this.Name = "AmortListUC";
      this.Text = "AmortListUC";
   }

   #endregion AmortListUC
   ...
   protected override void CreateHamperSpecifikum()
   {
      ...
      rbtSortByVKnum       = hampSpecifikum.CreateVvRadioButton  (0, 2, new EventHandler(rbtSortByVKnum_Click), "Od TT:", TextImageRelation.ImageAboveText);
      tbx_VK = hampSpecifikum.CreateVvTextBoxLookUp(1, 2, " tbx_VK", "Od tipa transakcije");
      ...
      tbx_VK.JAM_Set_LookUpTable(ZXC.luiListaAmortTT, (int)ZXC.Kolona.prva);
   ...
   protected override void CreateHamperFilter()
   {
      ...
      Label lblvk     = hampFilter.CreateVvLabel(0, 1, "TT:"                                 , System.Drawing.ContentAlignment.MiddleRight);
      ...
      tbx_filtVKnj.JAM_Set_LookUpTable(ZXC.luiListaAmortTT, (int)ZXC.Kolona.prva);
   ...
   private void rbtSortByBroj_Click(object sender, System.EventArgs e)
   {
      ...
      this.recordSorter = Amort.sorterDokNum;
   ...
   private void rbtSortByDatum_Click(object sender, System.EventArgs e)
   {
      RadioButton rbt   = sender as RadioButton;
      rBtcurrChecked    = OpenClose_VvTextBoxOnFindDialog(rbt, rBtcurrChecked);
      this.recordSorter = Amort.sorterDokDate;
   ...
   private void rbtSortByVKnum_Click(object sender, System.EventArgs e)
   {
      RadioButton rbt   = sender as RadioButton;
      rBtcurrChecked    = OpenClose_VvTextBoxOnFindDialog(rbt, rBtcurrChecked);
      this.recordSorter = Amort.sorterTtNum;
   ...
   private Vektor.DataLayer.DS_FindRecord.DS_findAmort ds_amort;
   
   protected override DataSet VirtualUntypedDataSet { get { return ds_amort; } }
   ...
   /// <summary>
   /// get { return ZXC.AmortDao.TheSchemaTable.Rows; }
   /// </summary>
   private DataRowCollection AmortSchemaRows
   {
      get { return ZXC.AmortDao.TheSchemaTable.Rows; }
   }

   /// <summary>
   ///  get { return ZXC.AmortDao.CI; }
   /// </summary>
   private AmortDao.AmortCI AmoCI
   {
      get { return ZXC.AmortDao.CI; }
   }
   ...
   public override void AddFilterMemberz()
   {
      ...
      drSchema = AmortSchemaRows[AmoCI.napomena];
      ...
      drSchema = AmortSchemaRows[AmoCI.tt];
      text     = Fld_FilterTT;
