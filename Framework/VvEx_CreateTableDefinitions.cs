...
{
   public static uint TableVersionStatic_VEKTOR { get { return 320; } }
   ...
   public static string AddNewVvUserControl_CommandText_VEKTOR(uint catchingVersion)
   {
      ...
      switch(catchingVersion)
      {
       ...
       //case 105: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_IMM.ToString(), "1", "2", "IMMDUC");
         ...
         case 298: return commandBeginning + GetCommandEnd(ZXC.VvReportEnum.RIZ_IntrastatUlaz .ToString(), "1", "5", "RIZ_IntrastatUlaz" , ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 299: return commandBeginning + GetCommandEnd(ZXC.VvReportEnum.RIZ_IntrastatIzlaz.ToString(), "1", "5", "RIZ_IntrastatIzlaz", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 300: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_POU.ToString(), "1", "2", "POU_DUC"        , ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 301: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_POI.ToString(), "1", "2", "POI_DUC"        , ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 302: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_ABU.ToString(), "1", "2", "BlgUplat_M_DUC" , ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 303: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_ABI.ToString(), "1", "2", "BlgIsplat_M_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");
         ...
         case 308: return commandBeginning + GetCommandEnd(ZXC.VvReportEnum.PIZ_PersonMatPodaci.ToString(), "3", "5", "PIZ_PersonMatPodaci", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 309: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_IRA_PTG.ToString(), "1", "2", "IRA_PTG_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 310: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_PVR_PTG.ToString(), "1", "2", "PVR_PTG_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 311: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_ZIZ_PTG.ToString(), "1", "2", "ZIZ_PTG_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 312: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_PVD_PTG.ToString(), "1", "2", "PVD_PTG_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 313: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_OPN_MPC.ToString(), "1", "2", "OPN_MPC_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 314: return commandBeginning + GetCommandEnd(ZXC.VvReportEnum.RIZ_LagerLista_Kol_A.ToString(), "1", "5", "RIZ_LagerLista_Kol_A", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 315: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_F2I.ToString()   ,  "1", "7", "F2_Izlaz_UC", ZXC.IsTEXTHOany2 ? "valentina" : "");
         case 316: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_F2U.ToString()   ,  "1", "7", "F2_Ulaz_UC" , ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 317: return commandBeginning + GetCommandEnd(ZXC.VvReportEnum.RIZ_RekapFakturWKupdob.ToString(), "1", "5", "RIZ_RekapFakturWKupdob", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 318: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_ZAR.ToString(), "1", "2", "ZAR_DUC", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 319: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_F2N.ToString(), "1", "7", "F2_NIR_UC", ZXC.IsTEXTHOany2 ? "valentina" : "");

         case 320: return commandBeginning + GetCommandEnd(ZXC.VvSubModulEnum.R_LED.ToString(),  "1", "7", "LedinekUC", ZXC.IsTEXTHOany2 ? "valentina" : "");
