...
public class TH_PriceRuleForCycleMoment
{
   ...
   private static Dictionary<DateTime, TH_Cjenik_Kind> TH_Cjenik_Kind_BreakDates_5Week = new Dictionary<DateTime, TH_Cjenik_Kind>
   {
    ...
    //{ new DateTime(2021, 04, 12), TH_Cjenik_Kind._5WShop_6WCjenik_ },21.04.2021. promjena cjenika
      ...
      { new DateTime(2026, 06, 08), TH_Cjenik_Kind._5WShop_6WCjenik_ },
      { new DateTime(2026, 07, 20), TH_Cjenik_Kind._5WShop_6WCjenik_ },
      { new DateTime(2026, 08, 31), TH_Cjenik_Kind._5WShop_5WCjenik_ },
   };
   ...
   private static Dictionary<DateTime, TH_Cjenik_Kind> TH_Cjenik_Kind_BreakDates_3Week_SRI = new Dictionary<DateTime, TH_Cjenik_Kind>
   {
      ...
      { new DateTime(2026, 07, 15), TH_Cjenik_Kind._3WShop_SRI_4WCjenik_ },
      { new DateTime(2025, 08, 12), TH_Cjenik_Kind._3WShop_SRI_3WCjenik_ },
   ...
   public static void Init_TH_PriceRuleList()
   {
      ...
      ZXC.TH_PriceRuleList_W5_C5 = new List<TH_PriceRuleForCycleMoment>()
      {
         ...
         new TH_PriceRuleForCycleMoment(5,    2,  1,    0,   0,  0/*20M*/, false,0, "W5/5 Tjedan 2 Dan 1"/* happy hour 20 posto"*/),//odxxx opet bezuvjetni kuponi od 30.06.25 vraca se HH ... od 24.03.-30.06.2025 bili su kuponi bezuvjetno!
         new TH_PriceRuleForCycleMoment(5,    2,  2,    0,   0,  0/*20M*/, false,0, "W5/5 Tjedan 2 Dan 2"/* happy hour 20 posto"*/),//odxxx opet bezuvjetni kuponi od 30.06.25 vraca se HH ... od 24.03.-30.06.2025 bili su kuponi bezuvjetno!
         new TH_PriceRuleForCycleMoment(5,    2,  3,    0,   0,  0/*20M*/, false,0, "W5/5 Tjedan 2 Dan 3"/* happy hour 20 posto"*/),//odxxx opet bezuvjetni kuponi od 30.06.25 vraca se HH ... od 24.03.-30.06.2025 bili su kuponi bezuvjetno!
         new TH_PriceRuleForCycleMoment(5,    2,  4,    0,   0,  0/*20M*/, false,0, "W5/5 Tjedan 2 Dan 4"/* happy hour 20 posto"*/),//odxxx opet bezuvjetni kuponi od 30.06.25 vraca se HH ... od 24.03.-30.06.2025 bili su kuponi bezuvjetno!
         new TH_PriceRuleForCycleMoment(5,    2,  5,    0,   0,  0/*20M*/, false,0, "W5/5 Tjedan 2 Dan 5"/* happy hour 20 posto"*/),//odxxx opet bezuvjetni kuponi od 30.06.25 vraca se HH ... od 24.03.-30.06.2025 bili su kuponi bezuvjetno!
      ...
      ZXC.TH_PriceRuleList_W5_C6 = new List<TH_PriceRuleForCycleMoment>()
      {
         ...
         new TH_PriceRuleForCycleMoment(6,    2,  1,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 1"         ),
         new TH_PriceRuleForCycleMoment(6,    2,  2,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 2"         ),
         new TH_PriceRuleForCycleMoment(6,    2,  3,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 3"         ),
         new TH_PriceRuleForCycleMoment(6,    2,  4,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 4"         ),
         new TH_PriceRuleForCycleMoment(6,    2,  5,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 5"         ),
         new TH_PriceRuleForCycleMoment(6,    2,  6,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 6"         ),
         new TH_PriceRuleForCycleMoment(6,    2,  7,    0,   0,    0, false, 0, "W5/6 Tjedan 2 Dan 7"         ),
      ...
      ZXC.TH_PriceRuleList_W3_SRI_C4 = new List<TH_PriceRuleForCycleMoment>()
      {
         ...
         new TH_PriceRuleForCycleMoment(4,    1,  3,    0,   0,    0, false, 0, "W3/4 Tjedan 1 Dan 3 (PET) regular"   ),
         new TH_PriceRuleForCycleMoment(4,    1,  4,    0, 10M,    0, false, 0, "W3/4 Tjedan 1 Dan 4 (SUB) 10 posto"  ),
         new TH_PriceRuleForCycleMoment(4,    1,  5,    0, 10M,    0, false, 0, "W3/4 Tjedan 1 Dan 5 (NED) 10 posto"  ),
         new TH_PriceRuleForCycleMoment(4,    1,  6,    0, 10M,    0, false, 0, "W3/4 Tjedan 1 Dan 6 (PON) 10 posto"  ),
         new TH_PriceRuleForCycleMoment(4,    1,  7, 3.5M,   0,    0, false, 0, "W3/4 Tjedan 1 Dan 7 (UTO) do 3,5 EUR"),

         new TH_PriceRuleForCycleMoment(4,    2,  1, 3.5M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 1 (SRI) do 3,5 EUR"),
         new TH_PriceRuleForCycleMoment(4,    2,  2, 3.5M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 2 (ČET) do 3,5 EUR"),
         new TH_PriceRuleForCycleMoment(4,    2,  3,   3M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 3 (PET) do 3 EUR"  ),
         new TH_PriceRuleForCycleMoment(4,    2,  4,   3M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 4 (SUB) do 3 EUR"  ),
         new TH_PriceRuleForCycleMoment(4,    2,  5,   3M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 5 (NED) do 3 EUR"  ),
         new TH_PriceRuleForCycleMoment(4,    2,  6,   3M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 6 (PON) do 3 EUR"  ),
         new TH_PriceRuleForCycleMoment(4,    2,  7, 2.5M,   0,    0, false, 0, "W3/4 Tjedan 2 Dan 7 (UTO) do 2,5 EUR"),
