...
public struct FaktExStruct
{
   ...
   /*201 */ /*internal*/ public ushort  _f2_isFisk     ;
   /*202 *//*internal*/ public DateTime _f2_sentTS     ;
   /*203 */ /*internal*/ public ushort  _f2_isRejected ;
   /*204 */ /*internal*/ public ushort  _f2_isMrkAsPaid;
   /*205 */ /*internal*/ public ushort  _f2_R1kind     ;
   /*206 */ /*internal*/ public uint    _f2_prvFakRecID;
   /*207 */ /*internal*/ public ushort  _f2_isEizvj    ;
 ...
 //public decimal R_ukKCRP_rob { get { return this.S_ukKCRP       - this.S_ukKCRP_usl; } }
   ...
   { 
      get 
      {
         ...
         return this.TrnNonDel2.Count(rto => rto.T_serno.NotEmpty() && rto.T_serno.Contains(ZXC.PTG_PENDING_SernoPreffix) == false); 
      } 
   }
   ...
   public string VvDocumIdent 
   {
      ...
      { 
       ...
       //if(ThePFD.Dsc_Title.NotEmpty())     theIdent.Append("    " + ThePFD.Dsc_Title  + "  ");
         if(ThePFD.Dsc_Title.NotEmpty())     theIdent.Append("    " + title             + "  ");
   ...
   public Faktur Set_URA_kontra_faktur_From_IRA_orig_faktur() // assuming; this is T1 IRA 
   {
      Faktur orig_faktur_rec_IRA = this; // !!! 
...
//         if(F2_SentTS.IsEmpty()     ) return true; // nije jos ni poslan niti send API-em, niti eIzvj API-em - nema smisla osvjezavati FISK status 
 ...
 //}
   ...
   internal Faktur SplitThisFakturForNpMix()
   {
      ...
      decimal ratio1 = ZXC.DivSafe(this.S_ukKCRP_NP1, this.S_ukKCRP);

      decimal total_S_ukKC  = this.S_ukKC ;
      decimal total_S_ukKCR = this.S_ukKCR;
      decimal total_S_ukPdv = this.S_ukPdv;

      // 1. Faktur: 

      this.S_ukKCRP = this.S_ukKCRP_NP1;

      this.S_ukKC  *= ratio1; this.S_ukKC  = this.S_ukKC .Ron2();
      this.S_ukKCR *= ratio1; this.S_ukKCR = this.S_ukKCR.Ron2();
      this.S_ukPdv *= ratio1; this.S_ukPdv = this.S_ukPdv.Ron2();
      ...
      np2Faktur_rec.S_ukKC   = total_S_ukKC  - this.S_ukKC ;
      np2Faktur_rec.S_ukKCR  = total_S_ukKCR - this.S_ukKCR;
      np2Faktur_rec.S_ukPdv  = total_S_ukPdv - this.S_ukPdv;
...
public class FaktEx : VvDataRecord, IVvExtenderDataRecord
{
   ...
   public override void Memset0(uint ID)
   {
      ...
      /*201 */    this.currentData._f2_isFisk      = 0;
