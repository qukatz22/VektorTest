...
public class Prjkt : Kupdob
{
   ...
   public bool F2_IsServis       { get { return (F2_RolaKind != ZXC.F2_RolaKind.Nepoznato && F2_RolaKind != ZXC.F2_RolaKind.VlastitoKnjigovodstvo); } } // Veleform, Ljekarna Mamiæ,          ... 
   ...
   public bool F2_ImaSamoB2C     { get { return (F2_ImaB2C && !F2_ImaB2B                                                                         ); } } // Textho                             ... 
   public bool F2_ImaB2B         { get { return (F2_Provider != ZXC.F2_Provider_enum.NONE                                                        ); } } // Frigoterm, Metaflex, Panigale,     ... 
   public bool F2_ImaSamoB2B     { get { return (F2_ImaB2B && !F2_ImaB2C                                                                         ); } } // Frigoterm                          ... 
   public bool F2_ImaB2C_i_B2B   { get { return (F2_ImaB2C && F2_ImaB2B                                                                          ); } } //            Metaflex, Panigale,     ... 
   public bool F2_NEmaB2C_ni_B2B { get { return (F2_ImaB2C == false && F2_ImaB2B == false                                                        ); } } // HZTK, TZGML?                           
   ...
   {
      get { return this.currentExtData._isFiskCashOnly; }
