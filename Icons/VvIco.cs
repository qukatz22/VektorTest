...
public static class VvIco
{
 ...
 //public static Icon FirstRed              = new Icon(GetManifestResourceStream("Vektor.Icons.ToolStrip_Modul.firstRed.ico"                 ));
  ...
  //public static VvForm.VvSubMenu VvSubMenu_Rtrans              = new VvForm.VvSubMenu("Rtrans"                   , ZXC.vvMenuStyleEnum.MenuItemAndButton, "findSerLot"        , false, VvIco.FndGreen        , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_FindSerLot)                                    , "Rtrans"                             );
    ...
    public static VvForm.VvSubMenu VvSubMenu_KN_Dev              = new VvForm.VvSubMenu(ZXC.IsEURoERA_projectYear ?"EUR/ Dev": "Kn / Dev", ZXC.vvMenuStyleEnum.MenuItemAndButton, "switchKnDev"       , true , VvIco.SwitchKnDev     , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_ToggleKnDeviza)                       , "Prikaz dokumenta u EUR / devizi"                                         );
