...
public static class VvIco
{
 ...
 //public static Icon FirstRed              = new Icon(GetManifestResourceStream("Vektor.Icons.ToolStrip_Modul.firstRed.ico"                 ));
   ...
   public static VvForm.VvSubMenu VvSubMenu_DodajRed      = new VvForm.VvSubMenu("Dodaj red"         , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "addRow"      ,  true, VvIco.AddRow     , Keys.None, new EventHandler(ZXC.TheVvForm.DocumentUC_InsertRow)         , "Dodaj red"                   );
    ...
    public static VvForm.VvSubMenu VvSubMenu_KreirajDB     = new VvForm.VvSubMenu("Kreiraj DB"        , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "ceateDB"     ,  true, VvIco.New        , Keys.None, new EventHandler(ZXC.TheVvForm.PRJ_CreateDB)                 , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_AktivirajDB   = new VvForm.VvSubMenu("Aktiviraj DB"      , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "activDB"     ,  true, VvIco.New        , Keys.None, new EventHandler(ZXC.TheVvForm.PRJ_ActivateDB)               , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_InitNY        = new VvForm.VvSubMenu("Init NY"           , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "initNY"      , false, VvIco.FromUnix   , Keys.None, new EventHandler(ZXC.TheVvForm.Init_NY_Click)                , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_AmortNY       = new VvForm.VvSubMenu("Amort NY"          , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "amortNY"     , false, VvIco.FromUnix   , Keys.None, new EventHandler(ZXC.TheVvForm.Amort_NY)                     , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_RNMNY         = new VvForm.VvSubMenu("RNM NY"            , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "initRNM"     , false, VvIco.FromUnix   , Keys.None, new EventHandler(ZXC.TheVvForm.RNM_NY)                       , "Prijenops nedovrsenih RNM"   );
    public static VvForm.VvSubMenu VvSubMenu_OffixImpPrj   = new VvForm.VvSubMenu("OffixImport"       , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "import_prjkt", false, VvIco.FromUnix   , Keys.None, new EventHandler(ZXC.TheVvForm.ImportFromOffix)              , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_Logo          = new VvForm.VvSubMenu("Logo"              , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "logo_BLOB"   , false, VvIco.Logo       , Keys.None, new EventHandler(ZXC.TheVvForm.Set_Logo_BLOB)                , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_Logo2         = new VvForm.VvSubMenu("Logo2"             , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "logo2_BLOB"  , false, VvIco.Logo2      , Keys.None, new EventHandler(ZXC.TheVvForm.Set_Logo2_BLOB)               , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_Fisk          = new VvForm.VvSubMenu("Fisk"              , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "fiskCert"    , false, VvIco.FiskBlg    , Keys.None, new EventHandler(ZXC.TheVvForm.Set_FiskCert_BLOB)            , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_eSgn          = new VvForm.VvSubMenu("eSgn"              , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "eSgnCert"    , false, VvIco.Sgn        , Keys.None, new EventHandler(ZXC.TheVvForm.Set_ESgnCert_BLOB)            , "Description: "               );

    public static VvForm.VvSubMenu VvSubMenu_AddUsrToMySQL = new VvForm.VvSubMenu("Add Users to MySQL", ZXC.vvMenuStyleEnum.MenuItem_Only          , "btn_usrToSql",  true, VvIco.EmptyIcon  , Keys.None , new EventHandler(ZXC.TheVvForm.AddUsersToMySQL)             , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_EmpyBtn       = new VvForm.VvSubMenu(" "                 , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "btn_empty"   ,  true, VvIco.EmptyIcon  , Keys.None , null/*new EventHandler()*/                                  , "Description: "               );
    public static VvForm.VvSubMenu VvSubMenu_Download      = new VvForm.VvSubMenu("Download"          , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "downloadTL"  , false, VvIco.Download   , Keys.None , new EventHandler(ZXC.TheVvForm.Download_TecajList)          , "Description: "               );

    public static VvForm.VvSubMenu VvSubMenu_Send          = new VvForm.VvSubMenu("Send"              , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "sky_send"    , false, VvIco.Sky_send   , Keys.None, new EventHandler(ZXC.TheVvForm.SEND_ToSKY)                   , "Send"                        );
    public static VvForm.VvSubMenu VvSubMenu_Receive       = new VvForm.VvSubMenu("Receive"           , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "sky_receive" , false, VvIco.Sky_receive, Keys.None, new EventHandler(ZXC.TheVvForm.RECEIVE_FromSKY)              , "Receive"                     );
    public static VvForm.VvSubMenu VvSubMenu_ChkSND        = new VvForm.VvSubMenu("ChkSND"            , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "sky_ChkSND"  , false, VvIco.LastRed    , Keys.None, new EventHandler(ZXC.TheVvForm.Check_SEND_ToSKY)             , "Provjera Send"               );
    public static VvForm.VvSubMenu VvSubMenu_ChkRCV        = new VvForm.VvSubMenu("ChkRCV"            , ZXC.vvMenuStyleEnum.MenuItemAndButton      , "sky_ChkRCV"  , false, VvIco.FirstRed   , Keys.None, new EventHandler(ZXC.TheVvForm.Check_RECEIVE_FromSKY)        , "Provjera Receive"            );


    public static VvForm.VvSubMenu VvSubMenu_PreimenujCD         = new VvForm.VvSubMenu("PreimenujCD"              , ZXC.vvMenuStyleEnum.MenuItemAndButton, "rename_artiklCd"   , false, VvIco.Rename          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_RenameArtiklCD)                                , "Preimenuj šifru artikla"            );
    public static VvForm.VvSubMenu VvSubMenu_PreimenujNaziv      = new VvForm.VvSubMenu("PreimenujNaziv"           , ZXC.vvMenuStyleEnum.MenuItemAndButton, "rename_artiklName" , false, VvIco.Rename          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_RenameArtiklName)                              , "Preimenuj naziv artikla"            );
    public static VvForm.VvSubMenu VvSubMenu_NewCache            = new VvForm.VvSubMenu("NewCache"                 , ZXC.vvMenuStyleEnum.MenuItemAndButton, "newCache"          , false, VvIco.Resize          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_NewCache)                                      , "Regeneriraj cashe svih artikala"    );
    public static VvForm.VvSubMenu VvSubMenu_VvSubMenu_HAL_ExCJ  = new VvForm.VvSubMenu(ZXC.IsSvDUHdomena ? "HALMED" : "ExtCij", ZXC.vvMenuStyleEnum.MenuItemAndButton, "extCij", false, VvIco.AvansStorno     , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_ShowExternCijena)                              , "Description: "                      );
    
    public static VvForm.VvSubMenu VvSubMenu_MarkAsSENDed        = new VvForm.VvSubMenu("MarkAsSENDed"             , ZXC.vvMenuStyleEnum.MenuItemAndButton, "MarkAsSENDed"      , false, VvIco.MarkAsSENDed    , Keys.None, new EventHandler(ZXC.TheVvForm.MarkADDactionAs_SENDed_ToSKY)                       , "MarkAsSENDed"                       );
    public static VvForm.VvSubMenu VvSubMenu_MarkAsRECEIVEd      = new VvForm.VvSubMenu("MarkAsRECEIVEd"           , ZXC.vvMenuStyleEnum.MenuItemAndButton, "MarkAsRECEIVEd"    , false, VvIco.MarkAsRECEIVEd  , Keys.None, new EventHandler(ZXC.TheVvForm.MarkADDactionAs_RECEIVEd_FromSKY)                   , "MarkAsRECEIVEd"                     );
    public static VvForm.VvSubMenu VvSubMenu_LogLAN_ADD_action   = new VvForm.VvSubMenu("LogLAN ADD action"        , ZXC.vvMenuStyleEnum.MenuItemAndButton, "LogLANADDaction"   , false, VvIco.LogLANADDaction , Keys.None, new EventHandler(ZXC.TheVvForm.ForceADDaction4_LogLAN)                             , "LogLAN ADD action"                  );
    public static VvForm.VvSubMenu VvSubMenu_Un_MarkAsSENDed     = new VvForm.VvSubMenu("Un_MarkAsSENDed"          , ZXC.vvMenuStyleEnum.MenuItemAndButton, "UnMarkAsSENDed"    , false, VvIco.UnMarkAsSENDed  , Keys.None, new EventHandler(ZXC.TheVvForm.Un_MarkADDactionAs_SENDed_ToSKY)                    , "UnMarkAsSENDed"                     );
    public static VvForm.VvSubMenu VvSubMenu_Un_MarkAsDISPATCHed = new VvForm.VvSubMenu("Un_MarkAsDISPATCHed"      , ZXC.vvMenuStyleEnum.MenuItemAndButton, "UnMarkAsRECEIVEd"  , false, VvIco.UnMarkAsRECEIVEd, Keys.None, new EventHandler(ZXC.TheVvForm.Un_MarkADDactionAs_DISPACHED_ToShop_OrCentr_FromSKY), "UnMarkAsRECEIVEd"                   );
    public static VvForm.VvSubMenu VvSubMenu_CheckPrNabCij       = new VvForm.VvSubMenu("CheckPrNabCij"            , ZXC.vvMenuStyleEnum.MenuItemAndButton, "CheckPrNabCij"     , false, VvIco.CheckPrNabCij   , Keys.None, new EventHandler(ZXC.TheVvForm.Manual_CheckCache_CheckPrNabCij_CheckZPC)           , "CheckPrNabCij"                      );
    public static VvForm.VvSubMenu VvSubMenu_CheckMSU            = new VvForm.VvSubMenu("CheckMSU"                 , ZXC.vvMenuStyleEnum.MenuItemAndButton, "CheckMSU"          , false, VvIco.CheckMSU        , Keys.None, new EventHandler(ZXC.TheVvForm.Manual_CheckCache_badMSU)                           , ""                                   );
    public static VvForm.VvSubMenu VvSubMenu_LogLAN_RWT_action   = new VvForm.VvSubMenu("LogLAN RWT action"        , ZXC.vvMenuStyleEnum.MenuItemAndButton, "sky_forceSend"     , false, VvIco.Sky_forceSend   , Keys.None, new EventHandler(ZXC.TheVvForm.ForceRWTaction4_LogLAN)                             , "LogLAN RWT action"                  );
  //public static VvForm.VvSubMenu VvSubMenu_Rtrans              = new VvForm.VvSubMenu("Rtrans"                   , ZXC.vvMenuStyleEnum.MenuItemAndButton, "findSerLot"        , false, VvIco.FndGreen        , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_FindSerLot)                                    , "Rtrans"                             );
    public static VvForm.VvSubMenu VvSubMenu_NewThisCache        = new VvForm.VvSubMenu("NewThisCache"             , ZXC.vvMenuStyleEnum.MenuItemAndButton, "newThisCache"      , false, VvIco.ThisCache       , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_NewThisCache)                                  , "Regeneriraj cashe samo ovog artikla");
    public static VvForm.VvSubMenu VvSubMenu_DatabaseService     = new VvForm.VvSubMenu("Database Service"         , ZXC.vvMenuStyleEnum.MenuItemAndButton, "databaseService"   , false, VvIco.Proizvodnja     , Keys.None, new EventHandler(ZXC.TheVvForm.DatabaseService)                                    , "Database Service"                   );

    public static VvForm.VvSubMenu VvSubMenu_UndoReceive_RollItBack = new VvForm.VvSubMenu("UndoReceive_RollItBack", ZXC.vvMenuStyleEnum.MenuItemAndButton, "UndoReceive_RollItBack", false, VvIco.UndoReceive_RollItBack, Keys.None, new EventHandler(ZXC.TheVvForm.UndoReceive_RollItBack), "UndoReceive_RollItBack");


    public static VvForm.VvSubMenu VvSubMenu_KopirajU            = new VvForm.VvSubMenu("Kopiraj u"                , ZXC.vvMenuStyleEnum.MenuItemAndButton, "copyNewTT"         , false, VvIco.CopyNewTT       , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_CopyToSomeOtherTT)                                          , "Kopiraj u novi dokument drugog tipa"                                        );
    public static VvForm.VvSubMenu VvSubMenu_KN_Dev              = new VvForm.VvSubMenu(ZXC.IsEURoERA_projectYear ?"EUR/ Dev": "Kn / Dev", ZXC.vvMenuStyleEnum.MenuItemAndButton, "switchKnDev"       , true , VvIco.SwitchKnDev     , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_ToggleKnDeviza)                                             , "Prikaz dokumenta u kunama / devizi"                                         );
    public static VvForm.VvSubMenu VvSubMenu_EUR_DevBug23        = new VvForm.VvSubMenu("Bug2023"                  , ZXC.vvMenuStyleEnum.MenuItemAndButton, "DevBug23"          , true , VvIco.NiceKn          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_ToggleDeviza_BUG2023)                                       , "Ispravak krivo racunanja tecaja"                                         );
    public static VvForm.VvSubMenu VvSubMenu_StartLink           = new VvForm.VvSubMenu("StartLink"                , ZXC.vvMenuStyleEnum.MenuItemAndButton, "startLink"         , false, VvIco.StartLink       , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_LinkToOtherDocum)                                           , "Poveži sa drugim internim dokumentom"                                       );
    public static VvForm.VvSubMenu VvSubMenu_Storno              = new VvForm.VvSubMenu("Storno"                   , ZXC.vvMenuStyleEnum.MenuItemAndButton, "storno"            , false, VvIco.Storno          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_Storno)                                                     , "Storno prikazanog dokumenta"                                                );
    public static VvForm.VvSubMenu VvSubMenu_PodijeliRed         = new VvForm.VvSubMenu("Podijeli Red"             , ZXC.vvMenuStyleEnum.MenuItemAndButton, "7030"              , true , VvIco.Omjer7030       , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_7030)                                                       , "Podijeli red na dva: 30% i 70%"                                             );
    public static VvForm.VvSubMenu VvSubMenu_RewriteAllDoc       = new VvForm.VvSubMenu("RewriteAllDoc"            , ZXC.vvMenuStyleEnum.MenuItemAndButton, "rewriteAll"        , false, VvIco.RewriteAll      , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_RewriteAllDocuments)                                        , "Rewrite All Documents"                                                      );
    public static VvForm.VvSubMenu VvSubMenu_Proknjizi           = new VvForm.VvSubMenu("Proknjiži"                , ZXC.vvMenuStyleEnum.MenuItemAndButton, "knjizi"            , false, VvIco.Knjizi          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_LoadSingleFak2Nal)                                          , "Proknjiži ovaj dokument"                                                    );
    public static VvForm.VvSubMenu VvSubMenu_PobrisiKnjizenja    = new VvForm.VvSubMenu("PobrišiKnjiženja"         , ZXC.vvMenuStyleEnum.MenuItemAndButton, "rasknjizi"         , false, VvIco.Rasknjizi       , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_UndoFak2Nal)                                                , "Pobriši sva knjiženja vezana uz ovaj dokument"                              );
  //public static VvForm.VvSubMenu /*VvSubMenu_OffixImport*/     = new        VvSubMenu("OffixImport"              , ZXC.vvMenuStyleEnum.MenuItemAndButton, "import_rn"         , false, VvIco.FromUnix        , Keys.None, new EventHandler(              ImportFromOffix)                                                 , "ImportFromOffix"),                                                          
    public static VvForm.VvSubMenu VvSubMenu_AvansST             = new VvForm.VvSubMenu("AvansST"                  , ZXC.vvMenuStyleEnum.MenuItemAndButton, "avansStorno"       , false, VvIco.AvansStorno     , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_AvansStorno)                                                , "Napravi novi dokument sa stornom ovog dokumenta za predujam"                );
    public static VvForm.VvSubMenu VvSubMenu_OmjerPdv            = new VvForm.VvSubMenu("OmjerPdv"                 , ZXC.vvMenuStyleEnum.MenuItemAndButton, "pdvOmjer"          , true , VvIco.PdvOmjer        , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_PdvOmjer)                                                   , "Podijeli red u omjeru priznatog PDV-a"                                      );
    public static VvForm.VvSubMenu VvSubMenu_PRI                 = new VvForm.VvSubMenu("PRI"                      , ZXC.vvMenuStyleEnum.MenuItemAndButton, "spojiPRI"          , true , VvIco.SpojiPRI        , Keys.None, new EventHandler(ZXC.TheVvForm.TakeRowsFromManyDocumentsPRIorIZD_byTtDokDateKupdobCD_toUFAorIFA), "Učitaj stavke primki"                                                       );
    public static VvForm.VvSubMenu VvSubMenu_ISP                 = new VvForm.VvSubMenu("ISP"                      , ZXC.vvMenuStyleEnum.MenuItemAndButton, "copyToISP"         , false, VvIco.CpyToOrange     , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_Copy_UFA_to_ISP)                                            , "Kreiraj Bagajna Isplatnicu na osnovu ovog dokumenta"                        );
    public static VvForm.VvSubMenu VvSubMenu_Pravila_Fak         = new VvForm.VvSubMenu("Pravila"                  , ZXC.vvMenuStyleEnum.MenuItemAndButton, "fakPravila"        , false, VvIco.Settingss       , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_FakturRules)                                                , "Pravila"                                                                    );
    public static VvForm.VvSubMenu VvSubMenu_PrNabCij            = new VvForm.VvSubMenu("PrNabCij"                 , ZXC.vvMenuStyleEnum.MenuItemAndButton, "prnabCij"          , true , VvIco.PrnabCij        , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_PrNabCij)                                                   , "Prosječna nabavna cijena"                                                   );
    public static VvForm.VvSubMenu VvSubMenu_Popratnice          = new VvForm.VvSubMenu("Popratnice"               , ZXC.vvMenuStyleEnum.MenuItemAndButton, "popratnice"        , true , VvIco.ToXml           , Keys.None, new EventHandler(ZXC.TheVvForm.LoadPopratnica)                                                  , "Učitaj popratnice"                                                          );
    public static VvForm.VvSubMenu VvSubMenu_Grupiraj            = new VvForm.VvSubMenu("Grupiraj"                 , ZXC.vvMenuStyleEnum.MenuItemAndButton, "sinteza"           , true , VvIco.Sinteza         , Keys.None, new EventHandler(ZXC.TheVvForm.CalcVolumen_SynthesizeG2toG1)                                    , "Sumiraj i sintetiziraj podatke Tabilce dva (Detalji) i prikaži na Tablici 1");
    public static VvForm.VvSubMenu VvSubMenu_NiceKn              = new VvForm.VvSubMenu("NiceKn"                   , ZXC.vvMenuStyleEnum.MenuItemAndButton, "niceKn"            , true , VvIco.NiceKn          , Keys.Control | Keys.Subtract, new EventHandler(ZXC.TheVvForm.UFD_NiceKn)                                   , "Nice Kn"                                                                    );
    public static VvForm.VvSubMenu VvSubMenu_Rabat               = new VvForm.VvSubMenu("Rabat"                    , ZXC.vvMenuStyleEnum.MenuItemAndButton, "rbtAllTrans"       , true , VvIco.RbtAllTrans     , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_RBT_4Q)                                                     , "Ispuni sve stavke sa određenim postotkom rabata"                            );
    public static VvForm.VvSubMenu VvSubMenu_PostaviMPC          = new VvForm.VvSubMenu("PostaviMPC"               , ZXC.vvMenuStyleEnum.MenuItemAndButton, "postaviMPC"        , true , VvIco.PostaviMPC      , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_PostaviMPC)                                                 , "Postavi MPC"                                                                );

    public static VvForm.VvSubMenu VvSubMenu_FISK                = new VvForm.VvSubMenu("FISK"                     , ZXC.vvMenuStyleEnum.MenuItemAndButton, "fisk"             , false, VvIco.FiskBlg          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_Fiskalize_RACUN)                                            , "Fiskalizacija"                                                              );
    public static VvForm.VvSubMenu VvSubMenu_FISKopp             = new VvForm.VvSubMenu("FISKopp"                  , ZXC.vvMenuStyleEnum.MenuItemAndButton, "fiskOpp"          , false, VvIco.FiskOpp          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_Fiskalize_PoslovniProstor)                                  , "Fiskaliziraj poslovni prostor"                                              );
    public static VvForm.VvSubMenu VvSubMenu_CisStatus           = new VvForm.VvSubMenu("Cis Status"               , ZXC.vvMenuStyleEnum.MenuItemAndButton, "cisStatus"        , false, VvIco.CisStatus        , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_Fiskalize_GetCISserviceStatus)                              , "Cis Status"                                                                 );
    public static VvForm.VvSubMenu VvSubMenu_FiskSveNeFisk       = new VvForm.VvSubMenu("FiskSveNeFisk"            , ZXC.vvMenuStyleEnum.MenuItemAndButton, "fiskAll"          , false, VvIco.FiskBlg          , Keys.None, new EventHandler(ZXC.TheVvForm.RISK_Fiskalize_AllPreviously_NOTfiskalized)                      , "Fiskaliziraj sve nefiskalizirane"                                           );


    #region ImportOffix provjeriti treba
    public static VvForm.VvSubMenu VvSubMenu_OffixImport_Skl = new VvForm.VvSubMenu("OffixImport", ZXC.vvMenuStyleEnum.MenuItemAndButton, "import_skl", false, VvIco.FromUnix, Keys.None, new EventHandler(ZXC.TheVvForm.ImportFromOffix), "Description: ");
  //public static VvForm.VvSubMenu VvSubMenu_OffixImport     = new VvSubMenu("OffixImport"       , ZXC.vvMenuStyleEnum.MenuItemAndButton, "import_rn"  , false, VvIco.FromUnix   , Keys.None, new EventHandler(ImportFromOffix)              , "ImportFromOffix"),
