...
namespace Vektor.Reports.RIZ {
    ...
    public class CR_KnjigaURA : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Vektor.Reports.RIZ.CR_KnjigaURA.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCR_KnjigaURA : Component, ICachedReport {
        
        public CachedCR_KnjigaURA() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CR_KnjigaURA rpt = new CR_KnjigaURA();
            rpt.Site = this.Site;
            return rpt;
        }
