...
public /*sealed*/ partial class VvForm : DevExpress.XtraEditors.XtraForm
{
   ...
   private void TheTabControl_BeginFloating(object sender, DocumentCancelEventArgs e)
   {
      ...
      string reason;
      if(!VvDetachedDocumentContext.CanDetach(vvTabPage, out reason))
      {
         System.Diagnostics.Debug.WriteLine("P3-11 DETACH eligibility: detach ignored for tab '" + title + "' because " + reason + ".");
         return;
      }
