...
/*  */ preffix + KPM_ulaz_SumClause("05")  + "as K_NivVrj05    \n" ;
 ...
 lastFakturCI = CI.decimal02; // !!!!!! 
   ...
   public static bool SetMeLastRtransForTtAndTtNum(XSqlConnection conn, Rtrans rtrans_rec, string _tt, uint _ttNum, bool _shouldBeSilent)
   {
      bool success = true;

      using(XSqlCommand cmd = VvSQL.SetMeLastRtransForTtAndTtNum_Command(conn, _tt, _ttNum, rtrans_rec))
      {
         success = ZXC.RtransDao.ExecuteSingleFillFromDataReader(rtrans_rec, false, cmd, true);
      } // using cmd 
      ...
      if(!success && !_shouldBeSilent)
      {
         VvSQL.ReportGeneric_DB_Error("", "Podatak: [" + _tt + "-" + _ttNum.ToString("000000") + "] ne postoji u datoteci [" + Rtrans.recordName + ".", System.Windows.Forms.MessageBoxButtons.OK);
      }
   ...
   private static bool /*(bool, Faktur, Rtrans)*/ AutoAddFaktur(XSqlConnection conn, ref ushort line, Faktur faktur_rec, Rtrans rtrans_rec)
   {
      ...
      if(line == 1) // new zaglavlje needed 
      {
         ...
         // 2026: 20.02.2026. i za KnjTipC kada se importira sa diska - H treba ovo preskociti 
       //if(faktur_rec.IsF2 && ZXC.CURR_prjkt_rec.F2_RolaKind != ZXC.F2_RolaKind.KlijentServisa_TipA                                                                         ) // jer ako je XXX onda ostavi u VezniDok ono kaj je InvoiceType.ID - om definirano 
         if(faktur_rec.IsF2 && ZXC.CURR_prjkt_rec.F2_RolaKind != ZXC.F2_RolaKind.KlijentServisa_TipA && ZXC.CURR_prjkt_rec.F2_RolaKind != ZXC.F2_RolaKind.KlijentServisa_TipC) // jer ako je XXX onda ostavi u VezniDok ono kaj je InvoiceType.ID - om definirano 
         {
...
public sealed class FaktExDao : VvDaoBase, IVvDao
{
   ...
   public static   uint TableVersionStatic { get { return 25; } }
   ...
   public static string Create_table_definition(bool isArhiva)
   {
      return (
         ...
         /*205 */ "f2_R1kind      tinyint(1)  unsigned NOT NULL default '0'         ,\n" +
         /*206 */ "f2_prvFakRecID int(10)     unsigned NOT NULL default '0'         ,\n" +
         /*207 */ "f2_isEizvj     tinyint(1)  unsigned NOT NULL default '0'         ,\n" +
   ...
   public static string Alter_table_definition(uint catchingVersion, bool isArhiva)
   {
      ...
      switch(catchingVersion)
      {
        ...
        case 24: return ("ADD    COLUMN f2_prvFakRecID int(10)     unsigned NOT NULL default '0' AFTER f2_AMSstatus      ;\n");

        case 25: return ("ADD    COLUMN f2_isEizvj  tinyint(1)  unsigned NOT NULL default '0' AFTER f2_prvFakRecID, " +
                         "CHANGE COLUMN f2_AMSstatus f2_R1kind TINYINT(1) UNSIGNED NOT NULL DEFAULT '0';  ");
   ...
   public void SetCommandParamValues(XSqlCommand cmd, VvDataRecord vvDataRecord, VvSQL.ParamListType plt, bool isArhiva)
   {
      ...
      /*205 */ VvSQL.CreateCommandParameter(cmd, preffix, faktEx.F2_R1kind      ,TheSchemaTable.Rows[CI.f2_R1kind     ]);
      /*206 */ VvSQL.CreateCommandParameter(cmd, preffix, faktEx.F2_PrvFakRecID ,TheSchemaTable.Rows[CI.f2_prvFakRecID]);
      /*207 */ VvSQL.CreateCommandParameter(cmd, preffix, faktEx.F2_IsEizvj     ,TheSchemaTable.Rows[CI.f2_isEizvj    ]);
      }
   ...
   public struct FaktExCI
   {
      ...
      /*205 */ internal int f2_R1kind     ;
      /*206 */ internal int f2_prvFakRecID;
      /*207 */ internal int f2_isEizvj    ;
   ...
   protected override void InitializeSchemaColumnIndexes()
   {
      ...
      /*205 */ CI.f2_R1kind      = GetSchemaColumnIndex("f2_R1kind");
      /*206 */ CI.f2_prvFakRecID = GetSchemaColumnIndex("f2_prvFakRecID");
      /*207 */ CI.f2_isEizvj     = GetSchemaColumnIndex("f2_isEizvj");

lastFaktExCI = CI.f2_isEizvj; // !!!!!! 
