...
- [~] Detached toolbar command routing — P3-37 revertira P3-36 agresivno kloniranje barova zbog floating toolbar regresije i ruti legacy `TheVvTabPage` / `TheVvUC` accessore kroz active detached host; selektivni detached command itemi još otvoreni
