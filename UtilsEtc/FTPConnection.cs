...
//         throw new IOException("Couldn't connect to remote server");
		...
		{
			Close();
			throw new Exception("Vv_01: " + (string)tempMessageList[0]);
		}
		...
		{
			Close();
         throw new Exception("Vv_02: " + (string)tempMessageList[0]);
		}
		...
		if(returnValue == 331)
		{
			...
			{
				Close();
            throw new Exception("Vv_03: " + (string)tempMessageList[0]);
			}
		}
	}
	...
	public ArrayList Dir()
	{
		...
		{
         throw new Exception("Vv_04: " + (string)tempMessageList[0]);
		}
		...
		if(!(returnValue == 226))
		{
         throw new Exception("Vv_05: " + returnValueMessage);
		}
	...
	public ArrayList XDir()
	{
		...
		{
         throw new Exception("Vv_06: " + (string)tempMessageList[0]);
		}
		...
		if(!(returnValue == 226))
		{
         throw new Exception("Vv_07: " + returnValueMessage);
		}
	...
	public void SendStream(Stream stream, string remoteFileName, FTPFileTransferType type)
	{
		...
		if(!(returnValue == 150 || returnValue == 125))
		{
         throw new Exception("Vv_08: " + (string)tempMessageList[0]);
		}
		...
		if(!(returnValue == 226))
		{
         throw new Exception("Vv_09: " + returnValueMessage);
		}
		UnlockTcpClient();
	}
	...
	public void GetStream(string remoteFileName, Stream stream, FTPFileTransferType type)
	{
		...
		if(!(returnValue == 150 || returnValue == 125))
		{
         throw new Exception("Vv_10: " + (string)tempMessageList[0]);
		}
		...
		if(!(returnValue == 226))
		{
         throw new Exception("Vv_11: " + returnValueMessage);
		}
	...
	public virtual void DeleteFile(String remoteFileName)
	{
		...
		if(returnValue != 250)
		{
         throw new Exception("Vv_12: " + (string)tempMessageList[0]);
		}
	...
	public virtual void RenameFile(string fromRemoteFileName, string toRemoteFileName)
	{
		...
		if(returnValue != 350)
		{
         throw new Exception("Vv_13: " + (string)tempMessageList[0]);
		}
		tempMessageList = SendCommand("RNTO " + toRemoteFileName);
		returnValue = GetMessageReturnValue((string)tempMessageList[0]);
		if(returnValue != 250)
		{
         throw new Exception("Vv_14: " + (string)tempMessageList[0]);
		}
		System.Threading.Monitor.Exit(this.tcpClient);
	}
	...
	public virtual void SetCurrentDirectory(String remotePath)
	{
		...
		if(returnValue != 250)
		{
         throw new Exception("Vv_15: " + (string)tempMessageList[0]);
		}
		UnlockTcpClient();
	}
	...
	private void SetTransferType(FTPFileTransferType type)
	{
		switch (type)
		{
			...
			case FTPFileTransferType.Binary:
				...
				break;
			default:
            throw new Exception("Vv_16: " + "Invalid File Transfer Type");
		}
	}
	...
	private void SetMode(string mode)
	{
		...
		if(returnValue != 200)
		{
         throw new Exception("Vv_17: " + (string)tempMessageList[0]);
		}
		UnlockTcpClient();
	}
	...
	private void SetDataPort(int portNumber)
	{
		...
		if(returnValue != 200)
		{
         throw new Exception("Vv_18: " + (string)tempMessageList[0]);
		}
		UnlockTcpClient();
	...
	public virtual void MakeDir(string directoryName)
	{
		...
		if(returnValue != 257)
		{
         throw new Exception("Vv_19: " + (string)tempMessageList[0]);
		}
	...
	public virtual void RemoveDir(string directoryName)
	{
		...
		if(returnValue != 250)
		{
         throw new Exception("Vv_20: " + (string)tempMessageList[0]);
		}
	...
	private ArrayList Read ()
	{
		...
		while(tempMessage.Count == 0)
		{
			if(tryCount == 10)
			{
            throw new Exception("Vv_21: " + "Server does not return message to the message");
			}
		...
		switch (this.mode)
		{
			...
			case FTPMode.Passive:
				...
				if(returnValue != 227)
				{
					...
					{
                  throw new Exception("Vv_22: " + (string)tempMessageList[0]);
					}
					else
					{
                  throw new Exception("Vv_23: " + (string)tempMessageList[0] + " Passive Mode not implemented");
					}
				}
