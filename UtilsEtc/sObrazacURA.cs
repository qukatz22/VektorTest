...
namespace PDV_URA {
   ...
   [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.6.1055.0")]
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://e-porezna.porezna-uprava.hr/sheme/zahtjevi/ObrazacURA/v1-0")]
    [System.Xml.Serialization.XmlRootAttribute("ObrazacURA", Namespace="http://e-porezna.porezna-uprava.hr/sheme/zahtjevi/ObrazacURA/v1-0", IsNullable=false)]
    public partial class sObrazacURA {
         ...
         private static System.Xml.Serialization.XmlSerializer Serializer
         {
            get
            {
               if((serializer == null))
               {
                  serializer = new System.Xml.Serialization.XmlSerializer(typeof(sObrazacURA));
               }
               return serializer;
            }
         }
         ...
         public static bool Deserialize(string xml, out sObrazacURA obj, out System.Exception exception)
         {
            exception = null;
            obj = default(sObrazacURA);
            try
            {
               obj = Deserialize(xml);
               return true;
         ...
         public static bool Deserialize(string xml, out sObrazacURA obj)
         {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
         }

         public static sObrazacURA Deserialize(string xml)
         {
            System.IO.StringReader stringReader = null;
            try
            {
               stringReader = new System.IO.StringReader(xml);
               return ((sObrazacURA)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
         ...
         /// <param name="exception">output Exception value if deserialize failed</param>
         /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
         public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out sObrazacURA the_eRacun, out System.Exception exception)
         {
            exception = null;
            the_eRacun = default(sObrazacURA);
            try
            {
         ...
         public static bool LoadFromFile(string fileName, out sObrazacURA the_eRacun, out System.Exception exception)
         {
            return LoadFromFile(fileName, /*Encoding.UTF8*/ ZXC.VvUTF8Encoding_noBOM, out the_eRacun, out exception);
         }

         public static bool LoadFromFile(string fileName, out sObrazacURA the_eRacun)
         {
            System.Exception exception = null;
         ...
         public static sObrazacURA LoadFromFile(string fileName, System.Text.Encoding encoding)
         {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.6.1055.0")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://e-porezna.porezna-uprava.hr/sheme/zahtjevi/ObrazacURA/v1-0", IncludeInSchema=false)]
